...
public class WXPay {
    ...
    public static String requestSendRedPack(SendRedPackReqData sendRedPackReqData) throws Exception {
        return new SendRedPackService().request(sendRedPackReqData);
    }
