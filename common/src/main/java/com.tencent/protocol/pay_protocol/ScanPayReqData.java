...
public class ScanPayReqData {
    ...
    public boolean equals(Object o) {
        ...
        ScanPayReqData that = (ScanPayReqData) o;

        if (total_fee != that.total_fee) return false;
        if (appid != null ? !appid.equals(that.appid) : that.appid != null) return false;
        if (attach != null ? !attach.equals(that.attach) : that.attach != null) return false;
        if (auth_code != null ? !auth_code.equals(that.auth_code) : that.auth_code != null) return false;
        if (body != null ? !body.equals(that.body) : that.body != null) return false;
        if (device_info != null ? !device_info.equals(that.device_info) : that.device_info != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (auth_code != null ? auth_code.hashCode() : 0);
        return result;
    }
